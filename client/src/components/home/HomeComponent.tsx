  ...
  return (
    <div className='w-full justify-center items-center'>
        <div className='flex flex-col h-full'>
            ...
            <Image src='https://res.cloudinary.com/dcvvyhf8p/image/upload/v1702579471/Principal%20web%20Nexus/jkrdw4gpegwkfpdge28w.png' alt='home-image' width={361.44} height={310} className='w-auto h-auto mt-5' />
