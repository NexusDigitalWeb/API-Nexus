...
const FomrMail = (): React.ReactElement => {
  ...
  return (
    <div
      className="flex flex-col items-center bg-[#191A23] px-[20px] pt-[50px] pb-[30px] gap-[37px]"
      id="contactUs"
    >
      ...
      <div className="flex flex-col items-center gap-8 w-full">
        ...
        <div className="text-[13px] md:text-[15px] text-white flex flex-col items-center gap-[15px]">
          ...
          <p className="text-[14px] md:text-[18px] text-center p-1">
            ¡Dejanos tu email para recibir mas información!
          </p>
        </div>
        <form
          className="h-[216px] w-[100%] max-w-[500px] items-center justify-center flex gap-[22px] flex-col p-[20px] bg-[#292A32] rounded-[14px]"
        ...
        >
          ...
          <button
            className="rounded-[14px] h-[68px] bg-[#B9FF66] px-[35px] py-[20px] w-full md:text-[20px]"
            type="submit"
          >
      ...
      <div className=" h-[30px] w-[130px] flex gap-[20px]">
        <Link
          href="/"
          className="flex items-center justify-center bg-white rounded-[50%] h-[30px] w-[30px] md:h-[40px] md:w-[40px]"
        >
          <Image
